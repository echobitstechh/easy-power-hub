...
class SavingsPaymentSheet extends StatefulWidget {
  final SheetRequest request;
  final Function(SheetResponse) completer;

  const SavingsPaymentSheet({
    Key? key,
  ...
  @override
  State<SavingsPaymentSheet> createState() => _SavingsPaymentSheetState();
}

class _SavingsPaymentSheetState extends State<SavingsPaymentSheet> {
  final TextEditingController _amountController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    final plan = widget.request.data as SavingsPlan?;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          verticalSpaceTiny,
          _buildInfoRow(context, "Goal",
              "₦${currencyFormat.format(plan?.goalAmount ?? 0)}"),
          verticalSpaceTiny,
          _buildInfoRow(context, "Balance",
              "₦${currencyFormat.format(plan?.balance ?? 0)}"),
          verticalSpaceMedium,
          Text(
            "Payment",
            style: TextStyle(
