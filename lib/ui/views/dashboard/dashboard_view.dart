...
class DashboardView extends StackedView<DashboardViewModel> {
  ...
  Widget _buildShimmerOrContent(
    ...
    if (viewModel.filteredProductList.isEmpty && viewModel.isBusy) {
      return Column(
        children: [
          buildShimmerContainer(), // shimmer for video/gif player placeholder
          verticalSpaceSmall,
          buildShimmerQuickActions(), // shimmer for categories
          verticalSpaceMedium,
          buildShimmerQuickActions(), // shimmer for quick actions
          verticalSpaceMedium,
          buildShimmerSlider(), // shimmer for raffle list
          verticalSpaceMedium,
          buildShimmerSlider(), // shimmer for donations
        ],
      );
    } else {
      return Column(
