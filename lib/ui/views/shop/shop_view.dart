  ...
  class ShopView extends StackedView<ShopViewModel> {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                _buildProductTagsSection(context, viewModel, overrideTags: useCategoryScoped ? categoryTags : null,),
                                SingleChildScrollView(
                                  scrollDirection: Axis.horizontal,
                                  child: Row(
                                    children: (useCategoryScoped ? categoryBrands : viewModel.filteredProductList
    ...
    Widget _buildProductTagsSection(BuildContext context, ShopViewModel viewModel,{
      List<Tag>? overrideTags,
    }) {
      final tagsToShow = overrideTags ?? viewModel.tags;
